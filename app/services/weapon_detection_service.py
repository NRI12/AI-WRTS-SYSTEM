    ...
    def _detect_core(video_id: int, app=None):
        ...
        with app.app_context():
            ...
            try:
                ...
                from app.services.ai.weapon_detection.weapon_detector import WeaponDetector
                ...
                print("\n[WeaponDetectionService] Đang chạy YOLOv8 detection...", flush=True)
                sys.stdout.flush()
                detection_result = WeaponDetector.detect_from_video(video_path)
