...
from app.services.ai.pose_scoring.pose_scorer import PoseScorer
    ...
    def _get_teacher_template_path(assignment_id: int) -> str:
        ...
        if not os.path.exists(template_path):
            ...
            try:
                ...
                print(f"[AIGradingService] Starting template extraction...", flush=True)
                sys.stdout.flush()
                teacher_template = PoseScorer.extract_template_from_video(instructor_video_path)
    ...
    def _grade_core(video_id: int, app=None):
        ...
        with app.app_context():
            ...
            try:
                ...
                print("\n[AIGradingService] Đang chạy pose comparison...", flush=True)
                sys.stdout.flush()
